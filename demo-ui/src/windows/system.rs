...
static FONT_OPTIONS: &[NamedFont] = font_table![
    ...
    (
        "Liberation Sans",
        "../../../demo/assets/LiberationSans-Regular.ttf"
    ),
    (
        "Liberation Sans Italic",
        "../../../demo/assets/LiberationSans-Italic.ttf"
    ),
    (
        "Liberation Serif",
        "../../../demo/assets/LiberationSerif-Regular.ttf"
    ),
    (
        "Liberation Serif Italic",
        "../../../demo/assets/LiberationSerif-Italic.ttf"
    ),
    ...
    (
        "Nunito SemiBold",
        "../../../demo/assets/Nunito_SemiBold.ttf"
    ),
    ("Nunito Bold", "../../../demo/assets/Nunito_Bold.ttf"),
    (
        "Nunito Bold Italic",
        "../../../demo/assets/Nunito_Bold_Italic.ttf"
    ),
    ...
    (
        "Times New Roman",
        "../../../demo/assets/TimesNewRoman-Regular.ttf"
    ),
    (
        "Times New Roman Italic",
        "../../../demo/assets/TimesNewRoman-Italic.ttf"
    ),
...
fn load_font(opt: &NamedFont) -> Arc<Font> {
    ...
    let fa = Font::from_slice(FA_ICONS)
        .expect("fa.ttf")
        .with_fallback(Arc::new(emoji));
    let font = Font::from_slice(opt.bytes)
        .expect("primary font")
...
pub fn default_font_index() -> usize {
    FONT_OPTIONS
        .iter()
        .position(|o| o.name == DEFAULT_FONT_NAME)
        .unwrap_or(0)
}
