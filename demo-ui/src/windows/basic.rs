//! Basic interactive widget demos: sliders and tooltips.
//!
...
//! light mode.
//!
//! The TextEdit and Code Editor demos moved to `text_edit_demo.rs` and
//! `code_editor_demo.rs`; they are re-exported from the `windows` module so
//! `windows::text_edit` / `windows::code_editor` still resolve.
...
use agg_gui::{
    ...
    SizedBox, Slider, Splitter, Tooltip, Widget,
};
