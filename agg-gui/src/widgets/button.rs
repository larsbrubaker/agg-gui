...
// `handle_event` lives in `button_events.rs` as a child module so it
// has direct access to Button's private fields/methods, and lifts the
// 90-line event-dispatch block out of this file to keep it under the
// 800-line cap.
